...
# 2. 划分数据集：训练集、验证集、测试集
x_train, x_temp, y_train, y_temp = train_test_split(x_data, y_data, test_size=0.4, random_state=42, shuffle=True)
...
# 保存结果到CSV文件
val_results.to_csv('YV-Bag-validation_results.csv', index=False)
test_results.to_csv('YV-Bag-test_results.csv', index=False)
