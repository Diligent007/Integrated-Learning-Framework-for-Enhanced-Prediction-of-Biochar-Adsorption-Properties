...
model_et.fit(x_train, y_train.squeeze())
...
# 保存结果到CSV文件
train_results.to_csv('YV-Catboost-training_results.csv', index=False)
val_results.to_csv('YV-Catboost-validation_results.csv', index=False)
test_results.to_csv('YV-Catboost-test_results.csv', index=False)